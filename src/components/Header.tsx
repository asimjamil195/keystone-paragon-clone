        ...
        <div className="container mx-auto px-4 bg-slate-50">
          <div className="flex justify-between items-center py-4 rounded-md bg-gray-50">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <img src="/lovable-uploads/9680bc2e-0b02-4b16-a021-028af5bacf18.png" alt="Keystone Consultants Pvt. Ltd." className="logo transition-transform duration-300 group-hover:scale-105" />
