        ...
        <div className="container mx-auto px-4 bg-slate-50">
          <div className="flex justify-between items-center py-4 rounded-md bg-gray-50">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <img src="/lovable-uploads/4d7c7234-b3d5-4d80-bf9b-d3110789d5e4.png" alt="Keystone Consultants" className="h-14 w-auto transition-transform duration-300 group-hover:scale-105" />
