            ...
            animationDelay: `${index * 0.3}s`
                ...
                <Card className="relative overflow-hidden bg-background/80 backdrop-blur-sm border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-elegant hover:-translate-y-2 group-hover:scale-105">
                  <div className="relative p-8 text-center">
                    {/* Step Number */}
                    <div className="absolute -top-44 left-1/2 transform -translate-x-1/2 w-8 h-8 rounded-full bg-gradient-to-r from-primary to-accent text-white text-sm font-bold flex items-center justify-center border-4 border-background shadow-lg">
                      {index + 1}
                    </div>
